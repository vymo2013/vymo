  ...
  return (
    <section className="relative section-pad hero-section overflow-x-hidden">
      <div className="container mt-5 lg:mt-[0px]">
        <div className="flex flex-wrap justify-between items-center px-[15px] lg:px-0 lg:mt-0 mb-4">
          ...
          <div className="w-full text-center lg:-mt-0 bg-vec pb-2">
            ...
            <h1
              textAlign="center"
              className="max-w-[280px] md:max-w-[1000px] text-center mx-auto text-36 leading-[44px] md:text-64 lg:mt-1 font-iight md:leading-[68px]">
