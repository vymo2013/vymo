      ...
      */}
      <div className="no-padding">
        <div className="row relative z-10 col-xs-12 col-8 offset-2">
          <div className="w-full lg:w-5/12 lg:top-3 lg:h-[0%] p-3">
              <img src="/img/jeff.webp" alt="Jeff Morris" width="100%"/>
          </div>
          <div className="w-full lg:w-7/12 lg:top-3 lg:h-[0%] p-3">
              <img src="/img/red-box.png" alt="Jeff Morris" width="65px" heoght="65px" className="float-right"/>
              ...
              conversion.</h4>
              <cite>-</cite>
              <p className="font-medium md:text-15 opacity-80 mt-1 mb-0">Jeff Morris, VP-Marketing & Operations</p>
              <img src="/img/logo/bhhc.svg" alt="BHHC logo" width="200px"/>
          </div>
        </div>
      </div>
    </section>
