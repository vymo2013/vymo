          ...
          <div className="row relative z-10 m-pt-4 m-pads p-1 pt-0 pb-0">
            <div className="w-full lg:w-1/2 lg:top-3 lg:h-[0%] p-1">
              <h2 className="text-center lg:text-left text-28 md:text-48 text-white font-light leading-[38px] md:leading-[64px]">
                <span className="font-bold">The</span><i> single </i><span className="font-bold">pane of <span className="d-bck">glass for sellers.</span></span>
              </h2>
            ...
            <div className="w-full lg:w-1/2 p-1 md:p-1 mt-3 md:mt-6 lg:mt-0 relative z-10 pt-1 pl-0">

              <p className="text-center lg:text-left text-18 text-white opacity-70 mt-1 mb-[20px] pd-40r">
